...
- **Critical ordering**: Follow the numbered steps exactly
  ...
  - ALWAYS wait for all sub-agents to complete before synthesizing (step 4)  - NEVER write the research document with placeholder values  - This ensures paths are correct for editing and navigation
